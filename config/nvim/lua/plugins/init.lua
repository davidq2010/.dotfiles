...
return require("packer").startup({
	function(use)
		...
		use({
			...
			end, -- When upgrading the plugin, you must make sure that all installed parsers are updated to the latest version via :TSUpdate
		...
		-- autopairs
		use({ "windwp/nvim-autopairs", config = config("nvim-autopairs"), after = "nvim-cmp" })
		...
		use({
			...
			config = config("nvim-dap"),
			requires = {
				{
					"rcarriga/nvim-dap-ui",
					config = config("nvim-dap-ui"),
				},
				{
					"theHamsta/nvim-dap-virtual-text",
					config = config("nvim-dap-virtual-text"),
				},
				{
